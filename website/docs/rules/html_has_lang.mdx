...
# Timestamp: 2020-07-19 23:10:37.978633
id: html_has_lang
title: html_has_lang
...
>
  ...
  <TabItem value="shell">
    <CodeSnippet
      snippet={`# The \`lang\` attribute must be present.\ncurlylint --rule 'html_has_lang: true' template.html\n# The \`lang\` attribute must match the configured language tag.\ncurlylint --rule 'html_has_lang: "en-US"' template.html\n# The \`lang\` attribute must match one of the configured language tags.\ncurlylint --rule 'html_has_lang: ["en", "en-US"]' template.html`}
      annotations={[]}
      lang="shell"
    />
  </TabItem>
